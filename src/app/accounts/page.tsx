    ...
    <main className="min-h-screen bg-[#ffffff] px-4 py-8">
      <div className="max-w-xl mx-auto">
        <div className="mb-6">
          ...
          <Link href="/expenses" className="inline-flex items-center gap-1.5 mt-1.5 px-3 py-1 rounded-full border border-[#121358] bg-[#121358] text-white text-xs font-semibold hover:bg-[#6668a8] hover:border-[#6668a8] transition-colors"><i className="fa-solid fa-arrow-rotate-left text-xs" />All History</Link>
        </div>
